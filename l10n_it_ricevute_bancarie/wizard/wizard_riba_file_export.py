    ...
    ***************************************************************************
    ...
    def _Record14(
        ...
        return (
            ...
            str(sia_credit).rjust(5, '0') + "4" + codice_cliente.ljust(16) + " " * 6 +
            self._valuta + "\r\n"
        )
    ...
    def _Record20(
        ...
        return (
            " 20" + str(self._progressivo).rjust(7, '0') + self._creditore[0:24] +
            indirizzo_creditore.ljust(24)[0:24] + cap_citta_creditore.ljust(24)[0:24] +
    ...
    def _Record30(self, nome_debitore, codice_fiscale_debitore):
        return (
            ...
            nome_debitore.ljust(60)[0:60] + codice_fiscale_debitore.ljust(16, ' ') +
            " " * 34 + "\r\n"
        )
    ...
    def _Record40(
        ...
        return (
            ...
            indirizzo_debitore.ljust(30)[0:30] + str(cap_debitore).rjust(5, '0') +
    ...
    def _Record51(self, numero_ricevuta_creditore):
        return (
            " 51" + str(self._progressivo).rjust(7, '0') +
            str(numero_ricevuta_creditore).rjust(10, '0') + self._creditore[0:20] +
            " " * 80 + "\r\n"
        )
    ...
    def act_getfile(self):
        ...
        for line in order_obj.line_ids:
            ...
            debitor_city = debitor_address.city and debitor_address.city.ljust(23)[
                0:23] or ''
            debitor_province = (
            ...
            Riba = [
                ...
                line.partner_id.vat and line.partner_id.vat[2:]
