...
class RibaConfiguration(models.Model):
    ...
    type = fields.Selection((('sbf', 'Subject To Collection'),
                             ('incasso', 'After Collection')),
                            "Issue Mode",
                            required=True)
    ...
    company_id = fields.Many2one(
        ...
        _company_default_get('riba.configuration')
    )
    ...
    def get_default_value_by_list(self, field_name):
        ...
        return (
            ribalist.config_id[field_name] and ribalist.config_id[field_name].id
            or False
        )
    ...
    def get_default_value_by_list_line(self, field_name):
        ...
        return (
            ...
            and ribalist_line.distinta_id.config_id[field_name].id or False
        )
