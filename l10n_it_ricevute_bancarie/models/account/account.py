...
class AccountMoveLine(models.Model):
    ...
    def fields_view_get(
        ...
        ids = model_data_obj.search([('module', '=', 'l10n_it_ricevute_bancarie'),
...
class AccountInvoice(models.Model):
    ...
    def action_move_create(self):
        for invoice in self:
            ...
            # ---- date of the month
            if (
                invoice.type != 'out_invoice' or not invoice.payment_term_id
            ...
            for pay_date in pterm_list[0]:
                if not invoice.month_check(pay_date[0], previous_date_due):
                    ...
                    line_vals = {
                        ...
                        'due_cost_line': True,
                        'name':
                            _('{line_name} for {month}-{year}').format(  # noqa E123
