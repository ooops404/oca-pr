...
STATES_MAPPING = {
    'draft': 'draft', 'cancel': 'cancel', 'in_pack': 'draft', 'done': 'confirm'
}
        ...
        self._map_create(
            ...
            lambda r: {
                ...
                'default_goods_appearance_id':
                    self._goods_descriptions[r.default_goods_description_id].id,
                'default_transport_reason_id':
                    self._transportation_reasons[r.default_transportation_reason_id].id,
                'default_transport_condition_id':
                    self._carriage_conditions[r.default_carriage_condition_id].id,
                'default_transport_method_id':
                    self._transportation_methods[r.default_transportation_method_id].id,
                'note': r.note
            }
        )
    ...
    def migrate_documents(self):
        ...
        def vals_getter(record):
            return {
                ...
                'gross_weight_uom_id':
                    record.gross_weight_uom_id.id or self._default_weight_uom.id,
                'net_weight': record.weight_manual or record.weight,
                'net_weight_uom_id':
                    record.weight_manual_uom_id.id or self._default_weight_uom.id,
                'goods_appearance_id':
